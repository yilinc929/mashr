...
write.csv(mashr_results, "/Users/cathy/Desktop/data_driven_cov_mashr_hedgeG_results.csv", row.names = FALSE)
...
#[1] "Pearson correlation for estimates: 0.430539957619609"
#[1] "Spearman correlation for estimates: 0.541576223722124"
...
write.csv(mashr_results_logFC, "/Users/cathy/Desktop/data_driven_cov_mashr_logFC_results.csv", row.names = FALSE)
...
#[1] "Pearson correlation for estimates: 0.545202855177808"
#[1] "Spearman correlation for estimates: 0.549397082234547"
