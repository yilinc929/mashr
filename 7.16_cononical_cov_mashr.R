...
#write.csv(significant_genes, "/Users/cyilin/Desktop/Sig_genes_hedgeG_canonical.csv", row.names = FALSE)
...
meta_significant <- metaresult_1 %>%
  filter(Pvalue <= 0.05) 
#write.csv(meta_significant, "/Users/cyilin/Desktop/Sig_genes_meta.csv", row.names = FALSE)
...
#write.csv(significant_genes_2, "/Users/cyilin/Desktop/Sig_genes_logFC_canonical.csv", row.names = FALSE)
